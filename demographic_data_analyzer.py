...
def calculate_demographic_data(print_data=True):
    ...
    rich_no_country=df[df["salary"] ==">50K"]["native-country"].value_counts()


    highest_earning_country = (rich_no_country/no_country*100).idxmax()

    highest_earning_country_percentage = round((rich_no_country/no_country*100).max(),1)

    # Identify the most popular occupation for those who earn >50K in India.
    people=df[(df["native-country"]=="India") & (df["salary"]==">50K")]
    occupation_count=people["occupation"].value_counts()
